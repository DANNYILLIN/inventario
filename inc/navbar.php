    ...
    <div id="navbarBasicExample" class="navbar-menu">
        <div class="navbar-start">
            ...
            <div class="navbar-item has-dropdown is-hoverable">
                ...
                <div class="navbar-dropdown">
                    <a href="index.php?vista=venta_nueva" class="navbar-item">Nueva</a>
                    <a href="index.php?vista=venta_lista" class="navbar-item">Lista</a>
                    <!--<a href="index.php?vista=product_category" class="navbar-item"></a>
                    <a href="index.php?vista=product_search" class="navbar-item"></a>-->
                </div>
            </div>
