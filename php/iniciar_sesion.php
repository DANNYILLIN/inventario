<?php
    ...
    $check_user=conexion();
    $check_user=$check_user->query("SELECT usuario_id, usuario_nombre, usuario_apellido, usuario_usuario, usuario_clave, rol_id FROM usuario WHERE usuario_usuario='$usuario'");
